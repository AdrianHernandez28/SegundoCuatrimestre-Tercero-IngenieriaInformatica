...
int main() {
  ...
  std::cout << "Primer byte: " << p.getFirstByte() << std::endl;
  std::cout << "Segundo byte: " << p.getSecondByte() << std::endl;
  std::cout << "Byte del algoritmo: " << p.getConstByte() << std::endl;
  std::cout << "Resultado de la multiplicación: " << p.getResult() << std::endl;
